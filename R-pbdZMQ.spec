...
Source0  : https://cran.r-project.org/src/contrib/pbdZMQ_0.3-12.tar.gz
...
%setup -q -n pbdZMQ
pushd ..
cp -a pbdZMQ buildavx2
popd
pushd ..
cp -a pbdZMQ buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725895284
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/pbdZMQ/libs/pbdZMQ.so
/V4/usr/lib64/R/library/pbdZMQ/libs/pbdZMQ.so
